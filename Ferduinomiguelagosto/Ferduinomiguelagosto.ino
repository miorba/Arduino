...
// descomenta cada línea según el tipo de luz que utilices, comenta las que uses
#define USE_UV
#define USE_Blue
#define USE_White
#define USE_RoyBlue
...
const byte ledPinBlue = 999;       // Pino que liga os leds azuis
...
const byte ledPinMoon = 999;     // Pino que liga os leds da luz noturna
