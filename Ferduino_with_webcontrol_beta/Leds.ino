...
void LED_levels_output()
{
  ...
  //////////////////////// CAMBIO REALIZADO POR MIGUEL ORTEGA /////////////////////
  /////// SI LAS LUCES LED ESTÁN ENCENDIDAS, LA LUZ DE LA LUNA ESTARÁ APAGADA//////
  if (bled_out < 10 & wled_out < 10 & rbled_out < 10 & rled_out < 10 & uvled_out < 10) 
  {
