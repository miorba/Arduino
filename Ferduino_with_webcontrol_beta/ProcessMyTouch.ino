  ...
  else
  {
    switch (dispScreen)
    {
      ...
      case 18: //--------------------------Tela configuracao de ph do aquario-----------------------------------
        ...
        else if (checkButtons(calM[0], calM[1], calM[2], calM[3]) == true)                        //press alarm minus
        {
          PHA2beC -= 0.01;
          if (PHA2beC < -99.99)
          {
        ...
        else if (checkButtons(calP[0], calP[1], calP[2], calP[3]) == true)                        //pulsar calibracion mas
        {
          PHA2beC += 0.01;
          if (PHA2beC > 99.99)
          {
      ...
      case 46:   // ----------------------------------------- Config alimentador automático --------------------------------------
        ...
        break;
       case 47: // Activa o desactiva Co2
       if (Co2_activado = 0)
          {
            Co2_activado = 1;
          }
